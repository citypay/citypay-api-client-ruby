...
module CityPayApiClient
  class DirectPostApi
    ...
    def direct_c_res_auth_request_with_http_info(uuid, opts = {})
      ...
      header_params['Accept'] = @api_client.select_header_accept(['application/json', 'application/xml', 'application/x-www-form-urlencoded']) unless header_params['Accept']
    ...
    def direct_post_auth_request_with_http_info(direct_post_request, opts = {})
      ...
      header_params = opts[:header_params] || {}
      # HTTP header 'Accept' (if needed)
      header_params['Accept'] = @api_client.select_header_accept(['application/json', 'application/xml', 'application/x-www-form-urlencoded', 'text/xml']) unless header_params['Accept']
      # HTTP header 'Content-Type'
