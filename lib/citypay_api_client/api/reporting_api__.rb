...
module CityPayApiClient
  class ReportingApi
    ...
    # @param transaction_report_request [TransactionReportRequest] 
    # @param [Hash] opts the optional parameters
    # @return [BatchTransactionReportResponse]
    def transaction_report_request(transaction_report_request, opts = {})
      data, _status_code, _headers = transaction_report_request_with_http_info(transaction_report_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(BatchTransactionReportResponse, Integer, Hash)>] BatchTransactionReportResponse data, response status code and response headers
    def transaction_report_request_with_http_info(transaction_report_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ReportingApi.transaction_report_request ...'
      end
      # verify the required parameter 'transaction_report_request' is set
      if @api_client.config.client_side_validation && transaction_report_request.nil?
        fail ArgumentError, "Missing the required parameter 'transaction_report_request' when calling ReportingApi.transaction_report_request"
      end
      # resource path
      local_var_path = '/v6/transactions'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(transaction_report_request)
      ...
      new_options = opts.merge(
        :operation => :"ReportingApi.transaction_report_request",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ReportingApi#transaction_report_request\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
