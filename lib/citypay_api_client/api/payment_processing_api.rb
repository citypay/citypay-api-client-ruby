  ...
  class PaymentProcessingApi
    ...
    def authorisation_request_with_http_info(auth_request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PaymentProcessingApi.authorisation_request",
    ...
    def c_res_request_with_http_info(c_res_auth_request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PaymentProcessingApi.c_res_request",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def capture_request_with_http_info(capture_request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PaymentProcessingApi.capture_request",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def pa_res_request_with_http_info(pa_res_auth_request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PaymentProcessingApi.pa_res_request",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def refund_request_with_http_info(refund_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentProcessingApi.refund_request ...'
      end
      # verify the required parameter 'refund_request' is set
      if @api_client.config.client_side_validation && refund_request.nil?
        fail ArgumentError, "Missing the required parameter 'refund_request' when calling PaymentProcessingApi.refund_request"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"PaymentProcessingApi.refund_request",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentProcessingApi#refund_request\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def retrieval_request_with_http_info(retrieve_request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PaymentProcessingApi.retrieval_request",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def void_request_with_http_info(void_request, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"PaymentProcessingApi.void_request",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
