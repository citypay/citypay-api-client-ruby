...
module CityPayApiClient
  class BatchProcessingApi
    ...
    def get_batch_report_request(batch_report_request, opts = {})
      data, _status_code, _headers = get_batch_report_request_with_http_info(batch_report_request, opts)
      data
    end
    ...
    def get_batch_report_request_with_http_info(batch_report_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BatchProcessingApi.get_batch_report_request ...'
      end
      ...
      if @api_client.config.client_side_validation && batch_report_request.nil?
        fail ArgumentError, "Missing the required parameter 'batch_report_request' when calling BatchProcessingApi.get_batch_report_request"
      end
      # resource path
      local_var_path = '/batch/retrieve'
      ...
      new_options = opts.merge(
        :operation => :"BatchProcessingApi.get_batch_report_request",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BatchProcessingApi#get_batch_report_request\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
