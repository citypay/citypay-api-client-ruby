...
module CityPayApiClient
  class PaylinkApi
    ...
    def paylink_token_close_request(token, opts = {})
      data, _status_code, _headers = paylink_token_close_request_with_http_info(token, opts)
      data
    end
    ...
    def paylink_token_close_request_with_http_info(token, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaylinkApi.paylink_token_close_request ...'
      end
      # verify the required parameter 'token' is set
      if @api_client.config.client_side_validation && token.nil?
        fail ArgumentError, "Missing the required parameter 'token' when calling PaylinkApi.paylink_token_close_request"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"PaylinkApi.paylink_token_close_request",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaylinkApi#paylink_token_close_request\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param token [String] The token returned by the create token process.
    # @param attachment [String] The attachemnt name requested.
    # @param [Hash] opts the optional parameters
    # @return [Acknowledgement]
    def token_attachment_status(token, attachment, opts = {})
      data, _status_code, _headers = token_attachment_status_with_http_info(token, attachment, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Acknowledgement, Integer, Hash)>] Acknowledgement data, response status code and response headers
    def token_attachment_status_with_http_info(token, attachment, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaylinkApi.token_attachment_status ...'
      end
      # verify the required parameter 'token' is set
      if @api_client.config.client_side_validation && token.nil?
        fail ArgumentError, "Missing the required parameter 'token' when calling PaylinkApi.token_attachment_status"
      end
      # verify the required parameter 'attachment' is set
      if @api_client.config.client_side_validation && attachment.nil?
        fail ArgumentError, "Missing the required parameter 'attachment' when calling PaylinkApi.token_attachment_status"
      end
      # resource path
      local_var_path = '/paylink/{token}/attachment-status/{attachment}'.sub('{' + 'token' + '}', CGI.escape(token.to_s)).sub('{' + 'attachment' + '}', CGI.escape(attachment.to_s))
      ...
      new_options = opts.merge(
        :operation => :"PaylinkApi.token_attachment_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaylinkApi#token_attachment_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
