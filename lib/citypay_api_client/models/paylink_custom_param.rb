  ...
  class PaylinkCustomParam
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'auth_meta_data')
        self.auth_meta_data = attributes[:'auth_meta_data']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          auth_meta_data == o.auth_meta_data &&
    ...
    def hash
      [auth_meta_data, entry_mode, field_type, group, label, locked, name, order, pattern, placeholder, required, value].hash
    end
