...
module CityPayApiClient
  class AirlineAdvice
    ...
    def list_invalid_properties
      ...
      if @ticket_issue_date.to_s.length > 10
        invalid_properties.push('invalid value for "ticket_issue_date", the character length must be smaller than or equal to 10.')
      end
    ...
    def valid?
      ...
      return false if @ticket_issue_date.to_s.length > 10
    ...
    def ticket_issue_date=(ticket_issue_date)
      if ticket_issue_date.nil?
        fail ArgumentError, 'ticket_issue_date cannot be nil'
      end

      if ticket_issue_date.to_s.length > 10
        fail ArgumentError, 'invalid value for "ticket_issue_date", the character length must be smaller than or equal to 10.'
      end
