# CityPayApiClient::VerificationRequest
...
| **cp_card_token** | **String** | The card token previously stored and created by the /tokenise route. | [optional] |
...
| **payment_intent_id** | **String** | A payment intent id previously registered that this transaction is linked to. | [optional] |
...
| **threeds_token** | **String** | The threedsecure token generated by a call to /areq which may or may not be challenged. | [optional] |
...
instance = CityPayApiClient::VerificationRequest.new(
  airline_data: null,
  amount: 19995,
