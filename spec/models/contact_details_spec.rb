...
# Unit tests for CityPayApiClient::ContactDetails
...
describe 'ContactDetails' do
  ...
  describe 'test an instance of ContactDetails' do
    it 'should create an instance of ContactDetails' do
      expect(@instance).to be_instance_of(CityPayApiClient::ContactDetails)
    end
  end
  ...
  describe 'test attribute "telephone_no"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
