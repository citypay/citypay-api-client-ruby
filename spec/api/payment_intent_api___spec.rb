...
# Unit tests for CityPayApiClient::PaymentIntentApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PaymentIntentApi' do
  before do
  ...
  describe 'test an instance of PaymentIntentApi' do
    it 'should create an instance of PaymentIntentApi' do
      expect(@api_instance).to be_instance_of(CityPayApiClient::PaymentIntentApi)
    end
  end
  ...
  # @param payment_intent_request_model 
  ...
  # @param find_payment_intent_request 
  # @param [Hash] opts the optional parameters
