...
```shell
gem install ./citypay_api_client-1.1.4.gem
```

(for development, run `gem install --dev ./citypay_api_client-1.1.4.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'citypay_api_client', '~> 1.1.4'
...
*CityPayApiClient::AuthorisationAndPaymentApi* | [**card_tokenisation_request**](docs/AuthorisationAndPaymentApi.md#card_tokenisation_request) | **POST** /v6/tokenise | Card Tokenisation Request
...
*CityPayApiClient::AuthorisationAndPaymentApi* | [**retrieval_request**](docs/AuthorisationAndPaymentApi.md#retrieval_request) | **POST** /v6/retrieve | Transaction Retrieval
*CityPayApiClient::AuthorisationAndPaymentApi* | [**verification_request**](docs/AuthorisationAndPaymentApi.md#verification_request) | **POST** /v6/verify | Verification
...
*CityPayApiClient::OperationalFunctionsApi* | [**register_temp_key**](docs/OperationalFunctionsApi.md#register_temp_key) | **POST** /v6/permissions/register-temp-ip | Register Temp Key
*CityPayApiClient::PaylinkApi* | [**paylink_token_close_request**](docs/PaylinkApi.md#paylink_token_close_request) | **PUT** /paylink/{token}/close | Close Paylink Token
...
*CityPayApiClient::PaylinkApi* | [**token_attachment_status**](docs/PaylinkApi.md#token_attachment_status) | **GET** /paylink/{token}/attachment-status/{attachment} | Checks an attachment status
...
*CityPayApiClient::PaymentIntentApi* | [**create_payment_intent**](docs/PaymentIntentApi.md#create_payment_intent) | **POST** /v6/intent/create | Create a Payment Intent
*CityPayApiClient::PaymentIntentApi* | [**get_payment_intent**](docs/PaymentIntentApi.md#get_payment_intent) | **POST** /v6/intent/retrieve | Retrieves a Payment Intent
...
*CityPayApiClient::ReportingApi* | [**transaction_report_request**](docs/ReportingApi.md#transaction_report_request) | **POST** /v6/transactions | Transaction Report Request
*CityPayApiClient::WebHooks* | [**web_hook_channel_create_request**](docs/WebHooks.md#web_hook_channel_create_request) | **POST** /hooks/channel/create | Web Hook Channel Create Request
*CityPayApiClient::WebHooks* | [**web_hook_channel_delete_request**](docs/WebHooks.md#web_hook_channel_delete_request) | **POST** /hooks/channel/delete | Web Hook Channel Delete Request
*CityPayApiClient::WebHooks* | [**web_hook_subscription_request**](docs/WebHooks.md#web_hook_subscription_request) | **POST** /hooks/subscribe | Web Hook Subscription Request
*CityPayApiClient::WebHooks* | [**web_hook_unsubscribe_request**](docs/WebHooks.md#web_hook_unsubscribe_request) | **POST** /hooks/unsubscribe | Web Hook Unsubscribe Request
...
## Documentation for Models
 ...
 - [CityPayApiClient::AdjustmentCondition](docs/AdjustmentCondition.md)
 - [CityPayApiClient::Adjustments](docs/Adjustments.md)
 ...
 - [CityPayApiClient::CardTokenisationRequest](docs/CardTokenisationRequest.md)
 - [CityPayApiClient::CardTokenisationResponse](docs/CardTokenisationResponse.md)
 ...
 - [CityPayApiClient::FindPaymentIntentRequest](docs/FindPaymentIntentRequest.md)
 - [CityPayApiClient::HttpConfig](docs/HttpConfig.md)
 ...
 - [CityPayApiClient::PaymentIntentRequestModel](docs/PaymentIntentRequestModel.md)
 - [CityPayApiClient::PaymentIntentResponseModel](docs/PaymentIntentResponseModel.md)
 ...
 - [CityPayApiClient::RegisterIpModel](docs/RegisterIpModel.md)
 ...
 - [CityPayApiClient::TransactionReportRequest](docs/TransactionReportRequest.md)
 - [CityPayApiClient::VerificationRequest](docs/VerificationRequest.md)
 - [CityPayApiClient::VoidRequest](docs/VoidRequest.md)
 - [CityPayApiClient::WebHookChannelCreateRequest](docs/WebHookChannelCreateRequest.md)
 - [CityPayApiClient::WebHookChannelCreateRequestConfig](docs/WebHookChannelCreateRequestConfig.md)
 - [CityPayApiClient::WebHookChannelCreateResponse](docs/WebHookChannelCreateResponse.md)
 - [CityPayApiClient::WebHookChannelDeleteRequest](docs/WebHookChannelDeleteRequest.md)
 - [CityPayApiClient::WebHookSubscriptionRequest](docs/WebHookSubscriptionRequest.md)
 - [CityPayApiClient::WebHookSubscriptionResponse](docs/WebHookSubscriptionResponse.md)
 - [CityPayApiClient::WebHookUnsubscribeRequest](docs/WebHookUnsubscribeRequest.md)
