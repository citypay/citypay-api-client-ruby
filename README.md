...
```shell
gem install ./citypay_api_client-1.0.6.gem
```

(for development, run `gem install --dev ./citypay_api_client-1.0.6.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'citypay_api_client', '~> 1.0.6'
